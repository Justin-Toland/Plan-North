...
var myFullpage = new fullpage('#fullpage', {
  ...
  onLeave: function onLeave(origin, destination, direction) {
    ...
    for (var i = 0; i < mobileNavElm.length; i++) {
      mobileNavElm[i].classList.remove('active');
    }

    for (var _i = 0; _i < mainNavNavElm.length; _i++) {
      mainNavNavElm[_i].classList.remove('active');
    }
...
var _loop = function _loop(i) {
  processButton[i].onclick = function (e) {
    ...
    for (var _i3 = 0; processButton.length > _i3; _i3++) {
      processButton[_i3].classList.remove('active');
    }

    processButton[i].classList.add('active'); // processFunction(dataId);

    for (var _i4 = 0; processDetails.length > _i4; _i4++) {
      processDetails[_i4].style.display = "none"; // Hide all detail blocks
    }

    processDetails[dataId - 1].style.display = "block"; // Show selected detail block

    var backgroundImg = processDetails[dataId - 1].children[0].src;

    for (var _i5 = 0; processFlexItem.length > _i5; _i5++) {
      processFlexItem[_i5].children[0].style.backgroundImage = "url(\"".concat(backgroundImg, "\")");
    }
...
var _loop2 = function _loop2(i) {
  gridNav.children[i].onclick = function () {
    for (var _i6 = 0; _i6 < isActive.children.length; _i6++) {
      isActive.children[_i6].classList.remove('active');
    }
    ...
    for (var _i7 = 0; _i7 < servicesFlexItem.length; _i7++) {
      if (_i7 === 3) {
        // Skip the details grid item
        continue;
      } else {
        servicesFlexItem[_i7].children[0].style.backgroundImage = "url(\"".concat(showElements[0].getAttribute('src'), "\")");
      }
    }

    for (var _i8 = 0; _i8 < details.children.length; _i8++) {
      details.children[_i8].classList.add('hidden');
    }

    for (var _i9 = 0; _i9 < showElements.length; _i9++) {
      showElements[_i9].classList.remove('hidden');
    }
...
var positionGridBackgrounds = function positionGridBackgrounds() {
  // Apply the x and y values to the fixed backgrounds position for the specified sections.
  var servicesFlexGridWidthDifference = (1184 - servicesFlexGrid.offsetWidth) / 2,
      processFlexGridWidthDifference = (584 - processFlexGrid.offsetWidth) / 2;

  var firstGridItem = function firstGridItem() {
    var elementWidth = servicesFlexGrid.children[0].offsetWidth;

    if (elementWidth != 286) {
      servicesFlexGrid.children[0].children[0].style.backgroundPosition = "-".concat(servicesFlexGridWidthDifference + 10, "px -100px"); // servicesFlexGrid width difference plus the inital 10 pixel shift.
    } else {
  ...
  var secondGridItem = function secondGridItem() {
    var elementWidth = servicesFlexGrid.children[1].offsetWidth;

    if (elementWidth != 286) {
      servicesFlexGrid.children[1].children[0].style.backgroundPosition = "-".concat(servicesFlexGridWidthDifference + elementWidth + 10 + 10, "px -100px"); // servicesFlexGrid width difference plus the inital 10 pixel shift plus the margin.
    } else {
  ...
  var thirdGridItem = function thirdGridItem() {
    var elementWidth = servicesFlexGrid.children[2].offsetWidth;

    if (elementWidth != 582) {
      servicesFlexGrid.children[2].children[0].style.backgroundPosition = "-".concat(servicesFlexGridWidthDifference + elementWidth + 10, "px -100px"); //servicesFlexGrid width difference plus the inital 10 pixel shift plus the margin. ElementWidth already includes the first 10px margin.
    } else {
  ...
  var fourthGridItem = function fourthGridItem() {
    var elementWidth = servicesFlexGrid.children[3].offsetWidth;

    if (elementWidth != 582) {
      servicesFlexGrid.children[4].children[0].style.backgroundPosition = "-".concat(servicesFlexGridWidthDifference + elementWidth + 10, "px -335px"); // servicesFlexGrid width difference plus large element width plus the margin.
    } else {
  ...
  var fifthGridItem = function fifthGridItem() {
    var elementWidthsmall = servicesFlexGrid.children[4].offsetWidth,
        elementWidthLarge = servicesFlexGrid.children[3].offsetWidth;

    if (elementWidthsmall != 286) {
      servicesFlexGrid.children[5].children[0].style.backgroundPosition = "-".concat(servicesFlexGridWidthDifference + elementWidthLarge + elementWidthsmall + 10 + 10, "px -335px"); // servicesFlexGrid width difference plus large and small elemnt width plus the two margins.
    } else {
      servicesFlexGrid.children[5].children[0].style.backgroundPosition = "-908px -335px";
    }
  };

  fifthGridItem(); // Processes

  var sixthGridItem = function sixthGridItem() {
    var elementWidth = processFlexGrid.children[0].offsetWidth;

    if (elementWidth != 282) {
      processFlexGrid.children[0].children[0].style.backgroundPosition = "-".concat(processFlexGridWidthDifference + 65, "px 0px"); // processFlexGrid width difference plus  width plus the margin.
    } else {
  ...
  var seventhGridItem = function seventhGridItem() {
    var elementWidth = processFlexGrid.children[1].offsetWidth;

    if (elementWidth != 282) {
      processFlexGrid.children[1].children[0].style.backgroundPosition = "-".concat(processFlexGridWidthDifference + elementWidth + 65, "px 0px"); // servicesFlexGrid width difference plus large element width plus the margin.
    } else {
  ...
  var eighthGridItem = function eighthGridItem() {
    var elementWidth = processFlexGrid.children[2].offsetWidth;

    if (elementWidth != 282) {
      processFlexGrid.children[2].children[0].style.backgroundPosition = "-".concat(processFlexGridWidthDifference + 65, "px -235px"); // servicesFlexGrid width difference plus large element width plus the margin.
    } else {
  ...
  var ninthGridItem = function ninthGridItem() {
    var elementWidth = processFlexGrid.children[3].offsetWidth;

    if (elementWidth != 282) {
      processFlexGrid.children[3].children[0].style.backgroundPosition = "-".concat(processFlexGridWidthDifference + elementWidth + 65, "px -235px"); // servicesFlexGrid width difference plus large element width plus the margin.
    } else {
...
var gridAdnimationFunction = function gridAdnimationFunction(catergory) {
  ...
  .staggerFromTo('.services-shuffle-top', .3, {
    autoAlpha: 0,
    x: -200
  }, {
    autoAlpha: 1,
  ...
  }, 0.1).staggerFromTo('.services-shuffle-bottom', .3, {
    autoAlpha: 0,
    x: -200
  }, {
    autoAlpha: 1,
  ...
  }, 0.1, '-=.4').staggerFromTo('.services-flex-item div', .3, {
    autoAlpha: 0
  }, {
    autoAlpha: 1
...
var processTimelineFunction = function processTimelineFunction(id) {
  processTimeline.staggerFromTo('.process-shuffle-left', .3, {
    autoAlpha: 0,
    y: -200
  }, {
    autoAlpha: 1,
  ...
  }, 0.1).staggerFromTo('.process-shuffle-right', .3, {
    autoAlpha: 0,
    y: -200
  }, {
    autoAlpha: 1,
  ...
  }, 0.1, '-=.2').staggerFromTo('.process-flex-item div', .3, {
    autoAlpha: 0
  }, {
    autoAlpha: 1
  }, 0.1, '-=.3').staggerFromTo(processDetails[id - 1].children, .5, {
    autoAlpha: 0,
    y: 50
  }, {
    autoAlpha: 1,
...
var projectsTimeline = new TimelineMax({
  delay: 1
});
projectsTimeline.staggerFromTo('.gallery-stagger', .5, {
  autoAlpha: 0,
  y: 50
}, {
  autoAlpha: 1,
  y: 0,
  ease: Back.easeOut.config(1.4)
}, 0.1, '-=.3'); // Projects gallery

var imageObj = {
  "gallery1": {
    "images": ["images/gallery/Beyster/01.jpg", "images/gallery/Beyster/02.jpg", "images/gallery/Beyster/03.jpg", "images/gallery/Beyster/04.jpg", "images/gallery/Beyster/05.jpg", "images/gallery/Beyster/06.jpg"],
    "details": {
      "header": "Beyster",
  ...
  "gallery2": {
    "images": ["images/gallery/Christopher/01.jpg", "images/gallery/Christopher/02.jpg", "images/gallery/Christopher/03.jpg", "images/gallery/Christopher/04.jpg", "images/gallery/Christopher/05.jpg", "images/gallery/Christopher/06.jpg"],
    "details": {
      "header": "Christopher",
      "client": "Sanctuary Architects | 2019",
  ...
  "gallery3": {
    "images": ["images/gallery/Freeman/01.jpg", "images/gallery/Freeman/02.jpg", "images/gallery/Freeman/03.jpg", "images/gallery/Freeman/04.jpg", "images/gallery/Freeman/05.jpg", "images/gallery/Freeman/06.jpg"],
    "details": {
      "header": "Freeman",
      "client": "Sanctuary Architects | 2019",
  ...
  "gallery4": {
    "images": ["images/gallery/Higgens/01.jpg", "images/gallery/Higgens/02.jpg", "images/gallery/Higgens/03.jpg", "images/gallery/Higgens/04.jpg", "images/gallery/Higgens/05.jpg", "images/gallery/Higgens/06.jpg"],
    "details": {
      "header": "Higgens",
      "client": "Sanctuary Architects | 2019",
  ...
  "gallery5": {
    "images": ["images/gallery/Response_Church/01.jpg", "images/gallery/Response_Church/02.jpg", "images/gallery/Response_Church/03.jpg", "images/gallery/Response_Church/04.jpg", "images/gallery/Response_Church/05.jpg", "images/gallery/Response_Church/06.jpg"],
    "details": {
  ...
  "gallery6": {
    "images": ["images/gallery/Martis/01.jpg", "images/gallery/Martis/02.jpg", "images/gallery/Martis/03.jpg", "images/gallery/Martis/04.jpg", "images/gallery/Martis/05.jpg", "images/gallery/Martis/06.jpg"],
    "details": {
...
function onChangeCallback() {
  ...
  console.log("The index of current slide is: ".concat(this.currentSlide));
  Array.prototype.slice.call(bulletContainer.children).forEach(function (element) {
  ...
  var clone = bulletContainer.children[this.currentSlide].cloneNode();
  bulletContainer.children[this.currentSlide].append(clone);
  TweenMax.fromTo(bulletContainer.children[this.currentSlide].children[0], 0.3, {
    autoAlpha: 1,
    scale: 0,
    ...
    scale: 2.5,
    onComplete: function onComplete() {
      bulletContainer.children[_this.currentSlide].innerHTML = "";
    }
  });
}
...
var removeExistingSlides = function removeExistingSlides() {
  var howManyExistingSlides = mySiema.innerElements.length;

  for (var i = 0; i < howManyExistingSlides; i++) {
    mySiema.remove(0);
  }
};

var galleryHeaderElm = document.getElementById('header'),
...
var addSelectedSlides = function addSelectedSlides(gallery) {
  var howManySlides = imageObj[gallery].images.length,
  ...
  for (var i = 0; i < howManySlides; i++) {
    ...
    newElement.appendChild(img); // let img = `<img src="${imageObj[gallery].images[i]}" alt="Project Image" />`;
...
var createBullets = function createBullets() {
  var howManySlides = mySiema.innerElements,
      bullets = "",
      slide = 0;
  Array.prototype.slice.call(howManySlides).forEach(function (element) {
    bullets += "<span data-slide='".concat(slide, "'></span>");
    slide++;
  });
...
var bulletClick = function bulletClick() {
  Array.prototype.slice.call(bulletContainer.children).forEach(function (element) {
...
bulletClick(); // Gallery Thumbnail

var galleryThumbnail = document.getElementsByClassName('gallery-thumbnail');

for (var i = 0; i < galleryThumbnail.length; i++) {
  galleryThumbnail[i].onclick = function (e) {
    var gallery = e.target.getAttribute('data-gallery');

    for (var _i2 = 0; _i2 < galleryThumbnail.length; _i2++) {
      galleryThumbnail[_i2].classList.remove('active');
    }
...
window.onload = function () {
  gridAdnimationFunction(category);
  processTimelineFunction(dataId); // processFunction(1); // Show intial process selection
